...
const SPACE_BETWEEN_ITEM_SLOTS: int = 5
...
func _init() -> void:
	...
	#ItemSlots_Sensor = GoodButton.new("", Color(BODY_COLOR, 0), Vector2(currInventorySize, SLOT_BAR_SIZE.y+5))#, GoodButton.ButtonType.SENSOR_ITEMBAR
	...
	hideModifiersTab = GoodButton.new("", Color.WHITE, Vector2(-1, -1), load("res://UI/TransitionArrows_small.png"))#, GoodButton.ButtonType.HIDE_MODIFIERS
	hideModifiersTab.HighlighColor = Color(0.9, 0.9, 0.9, 1)
	hideModifiersTab.PressedColor = Color(0.8, 0.8, 0.8, 1)
	...
	expandModifiersTab = GoodButton.new("", Color.WHITE, Vector2(-1, -1), load("res://UI/TransitionArrows_small.png"))#, GoodButton.ButtonType.REVEAL_MODIFIERS
	expandModifiersTab.HighlighColor = Color(0.9, 0.9, 0.9, 1)
	expandModifiersTab.PressedColor = Color(0.8, 0.8, 0.8, 1)
...
func resizeModifiersTab() -> void:
	...
	hideModifiersTab.position = Vector2(-hideModifiersTab.size.y/2, ModifiersTab.region_rect.size.y/2)
